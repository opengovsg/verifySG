...
process.env = {
  ...
  MOM_TWILIO_ACCOUNT_SID: 'TEST',
  MOM_TWILIO_API_KEY_SID: 'TEST',
  MOM_TWILIO_API_KEY_SECRET: 'TEST',
  MOM_TWILIO_SENDER_ID: 'TEST',
  MOH_TWILIO_ACCOUNT_SID: 'TEST',
  MOH_TWILIO_API_KEY_SID: 'TEST',
  MOH_TWILIO_API_KEY_SECRET: 'TEST',
  MOH_TWILIO_SENDER_ID: 'TEST',
}
