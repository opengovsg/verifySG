...
#### [v2.0.0](https://github.com/opengovsg/CheckWho/compare/v1.3.1...v2.0.0)

- feat: generate gogovsg links [`#478`](https://github.com/opengovsg/CheckWho/pull/478)
- feat: frontend to support sending SMS [`#474`](https://github.com/opengovsg/CheckWho/pull/474)
- feat: backend endpoint to send SMS with uniqueParamString [`#469`](https://github.com/opengovsg/CheckWho/pull/469)
- feat: add MAS and message template to onboard [`#467`](https://github.com/opengovsg/CheckWho/pull/467)
- chore: exclude api path from ServeStaticModule [`#480`](https://github.com/opengovsg/CheckWho/pull/480)
- fix: update api version in e2e tests [`#476`](https://github.com/opengovsg/CheckWho/pull/476)
- feat: endpoint to verify uniqueParamString [`#471`](https://github.com/opengovsg/CheckWho/pull/471)
- feat: add api versioning [`#475`](https://github.com/opengovsg/CheckWho/pull/475)
- fix: point to new EB environment [`#473`](https://github.com/opengovsg/CheckWho/pull/473)
- build(deps): bump loader-utils from 2.0.3 to 2.0.4 in /frontend-govt [`#466`](https://github.com/opengovsg/CheckWho/pull/466)
- feat: UniqueParamService to generate string to be added in the SMS [`#449`](https://github.com/opengovsg/CheckWho/pull/449)
- build(scripts): commands to tunnel to db (for migration) [`#463`](https://github.com/opengovsg/CheckWho/pull/463)
- fix: backend generateNewSGNotifyParams + CI/CD to new Beanstalk environments [`#464`](https://github.com/opengovsg/CheckWho/pull/464)
- feat: data model to support verifiable SMS [`#447`](https://github.com/opengovsg/CheckWho/pull/447)
- chore: fix security issues and upgrade dependencies [`#460`](https://github.com/opengovsg/CheckWho/pull/460)
- test: playwright [`#459`](https://github.com/opengovsg/CheckWho/pull/459)
- 1.3.1 [`#456`](https://github.com/opengovsg/CheckWho/pull/456)
...
- chore: bump to 1.3.1 [`df34a04`](https://github.com/opengovsg/CheckWho/commit/df34a048bb8b060b1d2beaf1d66afa065b37de0b)
